...
flowchart LR
  ...
  subgraph Riot["✦ Riot Services"]
    RiotAPI["Match &amp; Timeline V5"]
    DDragon["Data Dragon CDN"]
  end

  Viewer --> MatchAPI --> RiotAPI
  Guide --> DB
  Ladder --> DB
  Feed --> DB
  Admin --> DB
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0A323C,55:091428,100:010A13&height=140&section=footer&text=%E2%80%9CWe%E2%80%99ll%20be%20the%20best%20of%20friends%2C%20forever%20and%20ever!%E2%80%9D&fontSize=18&fontColor=C8AA6E&fontAlignY=74" width="100%" alt="footer" />
