			...
			<div className='max-w-4xl mx-auto'>
				...
				<div className='bg-yuumi-dark rounded-lg shadow-yuumi p-6 mb-8 animate-fade-in'>
					...
					<div className='prose prose-invert max-w-none text-yuumi-light'>
						...
						<p>Welcome to Yuum.Ai Dashboard ("we," "our," or "us"). By accessing or using our website, services, applications, and content (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms"). Please read these Terms carefully.</p>
						...
						<p>
							We may modify these Terms at any time. If we make changes, we will provide notice by updating the date at the top of these Terms and by maintaining a current version of the Terms at{' '}
							<Link href='/legal/terms' className='text-yuumi-primary hover:underline'>
								https://yuumai.com/legal/terms
							</Link>
							. Your continued use of our Services after the date any such changes become effective constitutes your acceptance of the new Terms.
						</p>

						<h2 className='text-xl font-semibold yuumi-gradient-text mt-6 mb-4'>4. Privacy Policy and Data Collection</h2>
						<p>
							Please refer to our{' '}
							<Link href='/legal/privacy' className='text-yuumi-primary hover:underline'>
								Privacy Policy
							</Link>{' '}
							for information about how we collect, use, and disclose information about you.
						</p>
						<p className='mt-4'>We are committed to minimizing data collection. We only collect your Discord username, Discord ID, and information about which Discord servers you are a member of. We do not collect your email address, device data, or usage data. If you choose to link your Riot Games account, we collect only the necessary information to provide our Services.</p>

						<h2 className='text-xl font-semibold yuumi-gradient-text mt-6 mb-4'>5. Account Registration</h2>
						<p>To use certain features of our Services, you may be required to register for an account. When you register, you agree to provide accurate, current, and complete information and to update this information to maintain its accuracy. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use of your account.</p>
						...
						<p>The Services and their contents, features, and functionality are owned by us, our licensors, or other providers and are protected by copyright, trademark, patent, and other intellectual property laws. You may not use, reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any of the material on our Services, except as permitted by these Terms.</p>

						<h2 className='text-xl font-semibold yuumi-gradient-text mt-6 mb-4'>8. Third-Party Services</h2>
						<p>
							Our Services may contain links to third-party websites or services that are not owned or controlled by us. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites or services. You further acknowledge and agree that we shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods, or
						...
						<p>We may terminate or suspend your access to all or part of the Services, without notice, for any conduct that we, in our sole discretion, believe is in violation of these Terms or is harmful to other users of the Services, us, or third parties, or for any other reason.</p>

						<h2 className='text-xl font-semibold yuumi-gradient-text mt-6 mb-4'>10. Disclaimer of Warranties</h2>
						<p>THE SERVICES ARE PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SERVICES ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.</p>
