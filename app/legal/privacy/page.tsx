      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-yuumi-dark rounded-lg shadow-yuumi p-6 mb-8 animate-fade-in">
          ...
          <div className="prose prose-invert max-w-none text-yuumi-light">
            ...
            <p>
              At Yuum.Ai Dashboard ("we," "our," or "us"), we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website, services, applications, and content (collectively, the "Services").
            </p>
            ...
            <ul className="list-disc pl-6 mb-4">
              <li>
                <strong>Personal Data:</strong> Personal identifiers such as name, email address, Discord ID, and Riot Games account information.
              </li>
              <li>
                <strong>Usage Data:</strong> Information about how you use our Services, including your browsing actions and patterns.
              </li>
              <li>
                <strong>Game Data:</strong> Information about your League of Legends gameplay, match history, and statistics.
              </li>
              <li>
                <strong>Device Data:</strong> Information about your device, internet connection, and browser.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>Automatically as you navigate through our Services (e.g., usage data).</li>
              <li>From third parties, such as Discord and Riot Games, when you connect your accounts.</li>
            </ul>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@yuumai.com" className="text-yuumi-primary hover:underline">privacy@yuumai.com</a>.
            </p>
