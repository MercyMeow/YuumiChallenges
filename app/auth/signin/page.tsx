		...
		<div className='min-h-screen bg-yuumi-darker flex flex-col justify-center items-center px-4'>
			<div className='w-full max-w-md'>
				...
				<div className='bg-yuumi-dark rounded-lg shadow-yuumi p-8 animate-slide-in-up'>
					...
					<button onClick={handleSignIn} disabled={isLoading} className='w-full flex items-center justify-center space-x-3 bg-[#5865F2] hover:bg-[#4752C4] text-white py-3 px-4 rounded-md transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#5865F2] focus:ring-offset-2 focus:ring-offset-yuumi-dark'>
						{isLoading ? (
					...
					<div className='mt-6 text-center'>
						<p className='text-yuumi-light text-sm'>
							...
							<a href='/legal/terms' className='text-yuumi-primary hover:underline'>
								Terms of Service
							</a>{' '}
							and{' '}
							<a href='/legal/privacy' className='text-yuumi-primary hover:underline'>
								Privacy Policy
							</a>
							.
						</p>
