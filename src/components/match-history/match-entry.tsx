...
export function MatchEntry({ match, compact = false }: MatchEntryProps) {
  ...
  if (compact) {
    return (
      <div className={`flex items-center justify-between p-3 rounded-lg border-l-4 ${getWinColor(match.win)} backdrop-blur-sm transition-all duration-200 hover:bg-white/5`}>
  ...
  return (
    <div className={`p-4 rounded-lg border-l-4 ${getWinColor(match.win)} bg-black/20 backdrop-blur-md border border-white/10 transition-all duration-200 hover:bg-white/5`}>
