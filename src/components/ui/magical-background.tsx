  ...
  return (
    <div className={`min-h-screen w-full relative ${className}`}>
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(135deg, oklch(0.08 0.05 285) 0%, oklch(0.06 0.08 250) 50%, oklch(0.08 0.06 270) 100%)'
        }}
      >
      ...
      <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
        <div 
          ...
          style={{
            backgroundColor: 'oklch(0.70 0.22 285 / 0.4)',
            boxShadow: '0 10px 15px -3px oklch(0.70 0.22 285 / 0.2), 0 4px 6px -2px oklch(0.70 0.22 285 / 0.1)'
          }}
        ></div>
        <div 
          className="absolute animate-subtle-pulse delay-1000 top-3/4 left-3/4 w-1 h-1 rounded-full" 
          style={{
            backgroundColor: 'oklch(0.68 0.20 250 / 0.4)',
            boxShadow: '0 10px 15px -3px oklch(0.68 0.20 250 / 0.2), 0 4px 6px -2px oklch(0.68 0.20 250 / 0.1)'
          }}
        ></div>
        <div 
          className="absolute animate-subtle-pulse delay-2000 top-1/2 left-1/6 w-1.5 h-1.5 rounded-full" 
          style={{
            backgroundColor: 'oklch(0.65 0.18 185 / 0.4)',
            boxShadow: '0 10px 15px -3px oklch(0.65 0.18 185 / 0.2), 0 4px 6px -2px oklch(0.65 0.18 185 / 0.1)'
          }}
        ></div>
        <div 
          className="absolute animate-subtle-pulse delay-500 top-1/6 left-2/3 w-1 h-1 rounded-full" 
          style={{
            backgroundColor: 'oklch(0.72 0.20 340 / 0.4)',
            boxShadow: '0 10px 15px -3px oklch(0.72 0.20 340 / 0.2), 0 4px 6px -2px oklch(0.72 0.20 340 / 0.1)'
          }}
        ></div>
        <div 
        ...
        <div 
          ...
          style={{
            backgroundColor: 'oklch(0.72 0.20 270 / 0.4)',
            boxShadow: '0 10px 15px -3px oklch(0.72 0.20 270 / 0.2), 0 4px 6px -2px oklch(0.72 0.20 270 / 0.1)'
          }}
        ></div>
        <div 
