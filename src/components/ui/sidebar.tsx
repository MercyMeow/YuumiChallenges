  ...
  return (
    <main
      ...
      className={cn(
        ...
        'md:ml-sidebar md:peer-data-[state=collapsed]:ml-sidebar-icon',
...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90%. Lazy state init keeps the value stable
  // across re-renders (same as the previous useMemo with empty deps).
