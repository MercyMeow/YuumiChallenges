...
export const yuumiBuild1518: ChampionBuildData = {
  ...
  notes: [
    ...
    "Pick Mikael's vs heavy CC, Putrifier for anti-heal, Ardent/Staff for synergy with carry damage profile.",
...
export const BEST_ITEMS = {
  ...
  situational: [
    ...
    },
    {
      ...
      reason: 'Apply Grievous Wounds early vs. high sustain comps.',
    },
    {
      id: 2065,
