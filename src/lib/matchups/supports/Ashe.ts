...
export const Ashe: SupportMatchup = {
  ...
  recommendedRunes:
    'Aery + Scorch standard. Guardian only if paired with a second hard engage (Nautilus, Leona).',
  recommendedItems:
    'Moonstone into Ardent or Staff by carry. Mikaels high value vs Arrow if no other cleanse on team.',
  earlyItems: ['Cloth Armor start vs lethal tempo ADC', 'Control Ward for brush traps'],
};
