...
export const Alistar: SupportMatchup = {
  difficulty: 'Medium',
  tips: [
    'Track his Flash cooldown. Flash W Q is his only reliable hard engage from long range. Ping it when used',
    'Sit at max detach range so if he Headbutts your host you can instantly W swap to a safer ally',
  ...
  recommendedRunes:
    'Sorcery Aery + Resolve (Bone Plating vs all in or Second Wind vs poke) swap to Guardian only if your ADC is immobile vs dive',
  recommendedItems:
    'Early Kindle gem into Moonstone. Consider Redemption second to mitigate his multi target engage. Mikaels not needed unless paired with extra hard CC (Ashe Varus)',
  earlyItems: [
    'Control Ward early river brush',
    'Rejuvenation Bead start viable into heavy attrition duo',
  ],
};
