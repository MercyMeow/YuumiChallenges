...
export const Galio: SupportMatchup = {
  difficulty: 'Hard',
  tips: [
    'Respect Flash + W taunt range — track Flash cooldown and stay at max attach distance at all times.',
  ...
  recommendedItems:
    'Moonstone into Shurelya\'s to disengage his engage windows. Mikaels situational vs heavy CC chains after taunt.',
