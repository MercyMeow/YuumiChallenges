...
export const Nami: SupportMatchup = {
  difficulty: 'Medium',
  tips: [
    'Aqua Prison (Q) suspension stops you from attaching while you are airborne — skew off-angle from your host and only detach to ward when she shows on wave.',
    ...
    "Save Exhaust for the target she empowers with Tidecaller's Blessing (E) in all-ins; have your carry pick up Grievous Wounds if her sustain starts winning trades.",
  ],
  recommendedRunes:
    'Aery + Scorch. Resolve Font of Life + Revitalize; Second Wind in double poke lanes.',
  recommendedItems:
    'Moonstone Renewer into Ardent Censer for on-hit ADCs or Staff of Flowing Water with AP allies. Dawncore later if the sustain war drags games long.',
