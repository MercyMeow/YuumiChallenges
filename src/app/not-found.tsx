      ...
      <div className="px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            ...
            >
              <div className="absolute -inset-0.5 rounded-xl bg-linear-to-r from-yuumi-purple to-yuumi-blue opacity-75 blur-sm transition duration-300 group-hover:opacity-100"></div>
              <div className="relative flex transform items-center rounded-xl bg-linear-to-r from-yuumi-purple to-yuumi-blue px-6 py-3 font-semibold text-white shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <Link
              ...
              className="group relative inline-flex items-center justify-center"
            >
              <div className="absolute -inset-0.5 rounded-xl bg-linear-to-r from-purple-500/50 to-blue-500/50 opacity-50 blur-sm transition duration-300 group-hover:opacity-75"></div>
